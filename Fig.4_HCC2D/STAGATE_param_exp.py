...
adata_direct = sc.read_h5ad(r'F:\spatial_data\processed\20230523_HCC_PRISM_probe_refined_processed\cell_typing\adata_leiden_res_1.h5ad')
...
for rad_cutoff in tqdm([300, 400]):
